...
const productSeeds: ProductSeed[] = [
  {
    ...
    images: ["/images/products/silicone-case-iphone-15.jpg"],
    priceCents: 1999,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/magsafe-clear-case-iphone-15.jpg"],
    priceCents: 2499,
    currency: "USD",
    status: "active",
    compatibleSlugs: ["iphone-15", "iphone-15-pro"],
  },
  {
    ...
    images: ["/images/products/leather-wallet-case-iphone-15-pro-max.jpg"],
    priceCents: 3499,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/rugged-armor-case-iphone-14.jpg"],
    priceCents: 2299,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/clear-case-galaxy-s23.jpg"],
    priceCents: 1999,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/silicone-case-galaxy-s23.jpg"],
    priceCents: 2199,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/hinge-armor-case-galaxy-z-flip-5.jpg"],
    priceCents: 2999,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/magsafe-clear-case-pixel-8.jpg"],
    priceCents: 2499,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/slim-fit-case-pixel-8.jpg"],
    priceCents: 2199,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/rugged-case-oneplus-11.jpg"],
    priceCents: 2399,
    currency: "USD",
    status: "active",
  ...
  },
  {
    ...
    images: ["/images/products/silicone-case-xiaomi-13.jpg"],
    priceCents: 1899,
    currency: "USD",
    status: "active",
